...
var RedState = /** @class */ (function () {
    ...
    RedState.prototype.action = function (signal) {
        // Red Light behavior
...
var GreenState = /** @class */ (function () {
    ...
    GreenState.prototype.action = function (signal) {
...
var YellowState = /** @class */ (function () {
    ...
    YellowState.prototype.action = function (signal) {
...
var TrafficLight = /** @class */ (function () {
    ...
    TrafficLight.prototype.setState = function (nextState) {
...
var TrafficLightTest = /** @class */ (function () {
    function TrafficLightTest() {
    }
    TrafficLightTest.test = function () {
        var signal = new TrafficLight(new RedState());
        signal.change(); // RED => GREEN
        signal.change(); // GREEN => YELLOW
        signal.change(); // YELLOW => RED
    };
    return TrafficLightTest;
}());
